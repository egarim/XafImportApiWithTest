...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<XafImportApiWithTestWindowsFormsApplication>();
        builder.Modules
            .AddCloningXpo()
            ...
            .Add<XafImportApiWithTest.Module.XafImportApiWithTestModule>()
        	.Add<XafImportApiWithTestWinModule>();
